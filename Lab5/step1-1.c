...
# Name: Yihui Qin
# Date: 02/01/2022 
# Title: Lab1 – task 1 - threadsync.c
# Description: This program solves the producer-consumer problem with one custoemr thread and one producer thread, which is a multi-threaded program with mutual exclusion using mutex and conditional variables.
*/
